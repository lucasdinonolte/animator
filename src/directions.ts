...
export const DirectionFunctions = {
  ...
  forward: (current: number, duration: number, iterationCount: number) => {
  ...
  // backwards execution
  alternate: (current: number, duration: number, iterationCount: number) => {
    const curIteration = Math.floor(current / duration);
  ...
  reverse: (current: number, duration: number, iterationCount: number) => {
    const curIteration = Math.floor(current / duration);
...
export type Direction = keyof typeof DirectionFunctions;
 ...
 */
export const resolveDirection = (direction: Direction) => {
